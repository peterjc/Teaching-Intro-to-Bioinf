...
\section{Workshop Data}
  \include{sections/subsection_locateworkshopdata}
  \include{sections/subsection_loadworkshopdata}

%%%
% SECTION: Gene Prediction
\section{Gene Prediction}
  \include{sections/subsection_genepredictionintro}
  %% Replaced with basic gene finding
  %\include{sections/subsection_orfprediction}
  \include{sections/subsection_basicgenefinding}
  \include{sections/subsection_prokaryoticgeneprediction}
  \include{sections/subsection_assessinggeneprediction}

%%%
% Whole genome comparisons
\section{Genome Comparisons}
  \include{sections/subsection_blastgenomecomparison}
  \include{sections/subsection_mummergenomecomparison}
...
%\section{Functional Prediction}
%  \include{sections/subsection_functionalprediction}

%%%
% SECTION: Gene Comparisons
\section{Gene Comparisons}
  \include{sections/subsection_reciprocalblast}
  %% Commented out for time
  % \include{sections/subsection_hmmer}
  %% Commented out for time
  % \include{sections/subsection_msa}
